...
app.get('/whatsound/api/v1/youtube/clip/values', function (req, res) {
    var query = removeDiacritics(req.query.query);
    query = (req.query.query != null && req.query.query != '' && req.query.query != "undefined") ? req.query.query : null;
    console.log(query);
    youtube.search(query, 2, function (error, result) {
        if (error) {
            ...
            if (result.pageInfo.totalResults == 0) {
                ...
                var response = 
                    [{
                    "id": (result['items'][0]['id']['videoId']!==  undefined)?JSON.stringify(result['items'][0]['id']['videoId']).replace(new RegExp('\\"', "g"), ""):null,
